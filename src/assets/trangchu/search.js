google.maps.__gjsload__("search", function (_) {
  var nta = function () {},
    ...
    pta = function (a) {
      ...
      const d = [];
      a.av().forEach((e) => {
        e.a && e.a.length >= 2 && d.push(new ota(e, b, c));
      });
      return d;
    },
    qta = function (a) {
    ...
    ota = class {
      ...
      getAnchor() {
        if (!this.anchor) {
          ...
          this.anchor = _.im(
            new _.wm(
              (this.wn.x * 256 + this.source.a[0]) / a,
              (this.wn.y * 256 + this.source.a[1]) / a
            )
          ).toJSON();
        }
        return this.anchor;
  ...
  cB.enableFeatureMapEventsRasterOnly = function (a) {
    if (_.an[15]) {
      var b = a.__gm.Xg;
      if (!sta.has(a)) {
        sta.add(a);
        var c = [],
          ...
          e = () => {
            ...
            b.forEach((f) => {
              if ((f = f.data))
                c.push(_.tk(f, "insert", (g) => d(g, "addfeatures"))),
                  c.push(_.tk(f, "remove", (g) => d(g, "removefeatures")));
            });
          };
  ...
  _.Fa(
    ...
    cB.enableFeatureMapEventsRasterOnly
  );
  _.ml(cB.prototype, { map: _.hp });
  _.ra.google.maps.search = { GoogleLayer: cB };
  _.lj("search", {});
});
