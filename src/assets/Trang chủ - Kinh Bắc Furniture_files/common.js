google.maps.__gjsload__("common", function (_) {
  ...
  _.er = function (a, b, c) {
    return new _.wm(
      a.Ws ? Via(a.Ws, b.Eg, c.Eg) : b.Eg,
      a.ou ? Via(a.ou, b.Fg, c.Fg) : b.Fg
    );
  };
  _.fr = function (a) {
    return { hh: Math.round(a.hh), kh: Math.round(a.kh) };
  };
  _.gr = function (a, b) {
    return { hh: a.m11 * b.Eg + a.m12 * b.Fg, kh: a.m21 * b.Eg + a.m22 * b.Fg };
  };
  _.hr = function (a) {
      ...
      (typeof a === "bigint"
        ? (0, _.re)(a)
          ...
          : ((a = BigInt.asIntN(64, a)),
            (a = (0, _.re)(a) ? Number(a) : String(a)))
        : (a = _.od(a) ? (typeof a === "number" ? _.Gd(a) : _.Ad(a)) : void 0));
    return a;
  };
  ...
  fja = function (a, b, c) {
    ...
    else if (_.ua(a) || typeof a === "string")
  ...
  _.Ir = function (a) {
    ...
    a instanceof _.Ir
      ...
      ? ((this.Jg = !1),
        ...
        Mr(this, b[6] || "", !0),
        _.Nr(this, b[7] || "", !0))
      : ((this.Jg = !1), (this.Fg = new _.Dr(null, this.Jg)));
  };
  _.Jr = function (a, b, c) {
    a.Hg = c ? Gr(b, !0) : b;
  ...
  Mr = function (a, b, c) {
    b instanceof _.Dr
      ? ((a.Fg = b), hja(a.Fg, a.Jg))
      : (c || (b = Hr(b, jja)), (a.Fg = new _.Dr(b, a.Jg)));
    return a;
  };
  _.Nr = function (a, b, c) {
    a.Kg = c ? Gr(b) : b;
  ...
  _.Qr = function (a, b, c) {
    ...
    if (e) _.Xg(a, b);
      ...
      a = _.wi(a, b);
      for (b = 0; !e; { done: e, value: f } = c.next()) a[b++] = d(f);
      a.length = b;
    }
  };
  _.Rr = function (a, b) {
  ...
  oja = async function () {
    if (_.oj ? 0 : _.nj())
      try {
        (await _.kj("log")).Dy.Ig();
      } catch (a) {}
  };
  _.as = async function (a) {
    if (_.nj())
      try {
        (await _.kj("log")).RD.Hg(a);
      } catch (b) {}
  };
  _.bs = function (a) {
  ...
  _.sja = function (a, b, c = !1) {
    b = _.hm(b);
    return new _.cl(
      b.fromPointToLatLng(new _.wl(a.min.Eg, a.max.Fg), c),
      b.fromPointToLatLng(new _.wl(a.max.Eg, a.min.Fg), c)
    );
  };
  us = function ({ qh: a, rh: b, Ah: c }) {
    return `(${a},${b})@${c}`;
  };
  ...
  _.xs = function (a, b) {
    return a && _.yj(b)
      ? ((a = _.uja(a, b)), Math.sqrt(a.x * a.x + a.y * a.y))
      : 0;
  };
  ...
  _.zja = function (a, b) {
    return a.classList
      ...
      : _.Mb(a.classList ? a.classList : _.Bs(a).match(/\S+/g) || [], b);
  };
  _.Cs = function (a, b) {
  ...
  _.Ns = function () {
    var a;
    (a = _.Wia()) ||
      ((a = _.cn), (a = a.type === 4 && a.Ng && _.jr(_.cn.version, 534)));
  ...
  Tja = function (a) {
    ...
    return a.ah.Fl({ clientX: b.left, clientY: b.top });
  };
  Uja = function (a, b, c) {
  ...
  Vja = function (a, b, c, d = !1) {
    ...
    e
      ...
      : (b = _.cr(c, _.xm(a.scale, { hh: b.x, kh: b.y })));
  ...
  $ja = function (a, b) {
    const c = Xt(a.Eg.Hl());
    var d = b.Eg.shiftKey;
    d = (a.Hg && c.Gm === 1 && a.Eg.wi.wI) || (d && a.Eg.wi.yF) || a.Eg.wi.sq;
  ...
  Xt = function (a) {
    ...
    a.length === 2 &&
      ...
      (g = Math.hypot(a, g)));
    const { vo: h, Jr: k } = { vo: f, Jr: g };
    return {
      yi: { clientX: c / b, clientY: d / b },
  ...
  $t = function (a) {
    a.Fg != -1 &&
      a.Ig &&
      (_.ra.clearTimeout(a.Fg), a.Kg.Fk(new _.Zt(a.Ig, a.Ig, 1)), (a.Fg = -1));
  };
  aka = function (a, b) {
    if (au(b)) {
      bu = Date.now();
      var c = !1;
      !a.Ig.Lg ||
        _.Ar(a.Eg.Eg).length != 1 ||
        (b.type != "pointercancel" && b.type != "MSPointerCancel") ||
        (a.Fg.ol(new _.Zt(b, b, 1)), (c = !0));
      var d = -1;
  ...
  bka = function (a, b) {
    ...
    a.Ig.Fk(
      new _.Zt(b, b.changedTouches[0], 1, () => {
  ...
  _.ju = function (a, b, c, d = Math.floor) {
    ...
    return {
      ...
      rh: d(e * (0.5 + (b.Fg / a.size.kh - 0.5) * a.Eg)),
      Ah: c,
    };
  };
  _.lu = function (a) {
  ...
  _.nu = function (a) {
    ...
    return {
      Dh: b,
      kl: a.kl,
      XJ: ({ ki: c, Zg: d, Ti: e, AM: f }) =>
        new jka({ Zg: d, ki: c, Qs: a.Mk(f, { Ti: e }), Dh: b }),
    };
  };
  pu = function (a) {
  ...
  mka = function (a, b, c, d) {
    ...
    if (a.isActive && b.Ah === a.Hg)
      if (!c && !d && Date.now() < a.Mg + 250)
        a.Kg = _.Vt(() => void mka(a, b, c, d), a.Mg + 250 - Date.now());
      else {
        a.Jg = b;
        nka(a);
        ...
        if (a.isActive && (d || a.Ig.kl !== 3))
          for (const h of qu(b)) {
            ...
            const k = h.Ah;
            var f = a.Ig.Dh,
              g = _.iu(f, { qh: h.qh + 0.5, rh: h.rh + 0.5, Ah: k });
            g = a.ah.Gj.wrap(g);
            f = _.ju(f, g, k);
            const m = a.Ig.XJ({ Zg: a.Fg, ki: h, AM: f });
            a.Eg.set(e, m);
            ...
            a.origin &&
              ...
              a.hint &&
              a.size &&
              m.Wh(a.origin, a.scale, a.hint.yp, a.size);
            a.Og
              ? m.loaded.then(() => void pka(a, m))
              : m.loaded.then(() => m.show(a.wx)).then(() => void pka(a, m));
          }
      }
  };
  nka = function (a) {
  ...
  pka = function (a, b) {
    if (a.Jg.has(b.ki)) {
      ...
      if (a.Og)
        for (const f of qu(a.Jg))
          (c = a.Eg.get(us(f))) && rka(a, f).length === 0 && c.show(!1);
    }
    nka(a);
  };
  rka = function (a, b) {
    ...
    for (const d of a.Eg.values())
      (a = d.ki), a.Ah !== b.Ah && ska(a, b) && c.push(us(a));
    return c;
  };
  qka = function (a, b) {
    return (b = a.Eg.get(us(b))) ? (a.Og ? b.bm() : b.Ux) : !1;
  };
  tka = function ({ qh: a, rh: b, Ah: c }, d) {
    d = c - d;
      ...
      if (!Gu) {
        ...
        if (!Uu) {
          Vu ||
            ((e = vu()),
            Wu || (Wu = [_.N, vu()]),
            (Vu = [_.Q, e, _.U, _.Qo, Wu, _.O]));
          e = Vu;
          if (!Xu) {
            Yu ||
              (Zu || ($u || ($u = [_.Q, , ,]), (Zu = [_.Q, _.Qo, $u])),
              (f = Zu),
              av || (bv || (bv = [_.Q]), (av = [_.Qo, bv])),
              (Yu = [Fka, f, Fka, av]));
            f = Yu;
            var g = vu();
            cv || (cv = [_.N, vu()]);
  ...
  gla = function (a, b) {
    ...
    if (e) {
      ...
      c.push(f);
      d.push({ dn: "MIdPd", Xt: 161532 });
    }
    if (_.an[15] && _.vi(a.Eg.Gg, 11))
      for (e = 0; e < _.vi(a.Eg.Gg, 11); e++)
        (f = new _.cw()), (f.layerId = _.xi(a.Eg.Gg, 11, e)), c.push(f);
    b &&
      d.forEach((g) => {
        b(g);
      });
  ...
  ila = function (a, b) {
    ...
    for (var e = 0; e < _.vi(a.Gg, 1); e++) {
      ...
      _.Y(f.Gg, 2, ew) &&
        ...
        _.Ys(g.mapsApiLayer, _.J(f.Gg, 2, _.dw, ew)),
        _.Y(_.J(f.Gg, 2, _.dw, ew).Gg, 1) && d.push({ dn: "MIdPd" }));
      c.push(g);
    }
    for (e = 0; e < _.vi(a.Gg, 6); e++)
      if (_.Y(_.Tq(a.Gg, 6, fw, e).Gg, 1, gw)) {
        d.push({ dn: "MldDdsl", Xt: 162701 });
        break;
      }
    for (e = 0; e < _.vi(a.Gg, 6); e++)
      if (_.Y(_.Tq(a.Gg, 6, fw, e).Gg, 2, gw)) {
        d.push({ dn: "MIdDdsDl", Xt: 177129 });
        break;
      }
    b &&
      d.forEach((f) => {
  ...
  _.pla = function (a) {
    ...
    return b.length || c || !_.yf(d) || a.length
      ? { paintExperimentIds: b, xx: c, LF: d, stylers: a }
      : null;
  };
  ...
  _.xla = function (a, b, c) {
    ...
    a.caseExperimentIds &&
      ((e = new sla()), _.Qr(e.Gg, 1, a.caseExperimentIds), _.Ss(c, tla, e));
    a.boostMapExperimentIds &&
      ((e = new ula()),
      _.Qr(e.Gg, 1, a.boostMapExperimentIds),
      _.Ss(c, vla, e));
  ...
  _.Tla = function (a, b) {
    ...
    b === 3
      ? ((a = _.Ii(a.request.Gg, 12, Sla)), _.Di(a.Gg, 5, !0))
      : _.Xg(a.request.Gg, 12);
  };
  ...
  _.Vla = function (a, b, c, d) {
    b === "terrain"
      ? ((b = _.Bw(a.request)),
        ...
        _.lw(a, "r"),
        _.mw(a, c))
      : ((a = _.Bw(a.request)), _.kw(a, 0), _.lw(a, "m"), _.mw(a, c));
  };
  Xla = function (a, b) {
    ...
    (b = b.stylers) &&
      ...
      b.forEach((d) => {
        ...
        for (let f = 0, g = _.vi(_.Cw(a.request).Gg, 12); f < g; f++)
          if (yla(_.Cw(a.request), f).getType() === e) {
            e = _.Dw(a.request);
            _.Pr(e.Gg, 12, f);
            break;
          }
  ...
  _.Qw = function () {
    return (
      ...
      _.qja("UrlAuthenticationCommonError")
    );
  };
  _.Sw = function () {
    oja();
  ...
  _.gma = function () {
    ...
    return (_.bx = new Promise(async (a) => {
      var b = await ema();
      _.Lt = b
        ? _.xn(new _.yn(131071), window.location.origin, b).toString()
        : "";
      b = await _.fma();
      a(b);
      _.ax = !1;
  ...
  _.ix = function (a) {
    ...
    return (e) => {
      const f = pma({ qh: e.rh, rh: e.qh, Ah: e.Ah }, d);
      ...
      if (e && b && _.yj(f) && (b = _.rm(e, b, f))) {
        a &&
          ...
          (e && e.getPov && e.getPov().heading() % 180 !== 0
            ? ((e = b.y - a.y), (e = _.wj(e, -f / 2, f / 2)), (b.y = a.y + e))
            : ((e = b.x - a.x),
              (e = _.wj(e, -(f / 2), f / 2)),
              (b.x = a.x + e)));
  ...
  _.G.fl = function (a) {
    ...
    let b = [];
    if (typeof a === "string")
      gja(this, a) && (b = b.concat(this.Eg.get(Fr(this, a))));
    else {
  ...
  _.G.toString = function () {
    ...
    if ((c = this.getPath()))
      this.Eg && c.charAt(0) != "/" && a.push("/"),
        a.push(Hr(c, c.charAt(0) == "/" ? Dma : Ema, !0));
  ...
  Ela = [_.Q, _.U];
  Wla = { dN: 0, bN: 1, YM: 2, ZM: 3, WM: 5, XM: 6, aN: 8 };
  Pla = [_.Uo];
  _.G = _.$r.prototype;
  _.G.clone = function () {
  ...
  _.Sma = {
    bF: function (a, b, c, d = 0) {
      ...
      if (e && f != null && g) {
        ...
        e = _.er(
          b.Gj,
          new _.wm((c.minX + c.maxX) / 2, (c.minY + c.maxY) / 2),
          a
        );
        c = _.dr(e, g);
        e = _.cr(e, g);
        ...
        (g === 0 && d === 0) ||
          b.ak(
            { center: _.cr(a, new _.wm(g, d)), zoom: f, heading: k, tilt: h },
            !0
          );
      }
    },
  };
  _.yx = { roadmap: "m", satellite: "k", hybrid: "h", terrain: "r" };
  xja = class {
    constructor() {
      var a = document;
      this.Eg = _.cn;
      this.transform = wja(a, [
        "transform",
        "WebkitTransform",
        "MozTransform",
        "msTransform",
  ...
  _.zx = (a, b) => {
    ...
    b = b.head || b;
    const c = _.Zha(b);
    c.has(a) || (c.add(a), _.zq(a(), { root: b, qw: !1 }));
  };
  ...
  var Dx = [_.zt, _.tx, ,];
  var Yma = ["KloTsA", _.uv, 7, Vma, _.N, Dx, Dx, [_.Q, _.zt, ,], [Hma, Gma]];
  _.Vr(
    "Hshb1g",
    300326985,
    class extends _.Bx {
  ...
  _.Ex = [_.Ro, ,];
  var Fx = [_.N, , _.wv, _.N, , , , , ,];
  var bna = [[Fx, _.Ex, _.N, [_.O, 2, , , ,], , _.U, _.O, _.Qo, Fx, _.O], _.Q];
  _.Vr(
    "KloTsA",
    293178560,
    class extends _.W {
  ...
  _.lna = [_.tx, ,];
  var Cja = [_.N, _.Qo, [_.O, , [[_.Q], _.lna, _.U, [_.ht], ,], _.Hx]];
  var bt;
  var it;
  var gt;
  var Dja = _.Rq(1, 2),
  ...
  var ula = class extends _.W {
    ...
    ona = [
      ...
      2,
      _.O,
      [_.U, , Pma, _.Qo, [_.N, _.U, ,]],
      1,
    ],
    vla = _.Vr("zjRS9A", 320033310, ula, function () {
      return ona;
    });
  var pna = [_.Qo, tt, , [_.N], _.Q, , , [_.ht], [_.N, , _.O], , _.Qo, tt];
  ...
  _.hoa = new _.Go(
    "/google.internal.maps.mapsjs.v1.MapsJsInternalService/GetWidgetContent",
    _.Pna,
    (a) => a.ui(),
    _.uf(
      class extends _.xo {
  ...
  var cy = [
    ...
    ,
    _.Qo,
    [_.Q, _.N, [_.zt, _.N, _.zt, _.U, _.N, , _.zt, 1, _.N, ,], , , _.To],
    _.Q,
    [_.Ro, _.To, , , ,],
    [_.Q, , _.N, _.U, , _.O, ,],
    _.To,
  ...
  var Rka = [
    ...
    [[_.N, _.U, _.O, , , , _.N, , ,], _.N],
    ,
    [_.N, _.O, _.zt, _.N, , _.zt, _.U],
    _.U,
    [_.Qo, [_.To, Wv, _.zt], _.O],
    Nma,
    [_.U, ,],
    _.Q,
    ,
  ...
  var zoa = [
    ...
    _.Q,
    _.O,
    [roa, Dx, roa, ay, soa, _.O, soa, [_.ov, _.O], 2],
    3,
    _.N,
    5,
    _.U,
  ...
  _.qy = class {
    constructor(a, b, c, d = () => {}) {
      ...
      _.Dk(a, "projection_changed", () => {
        ...
        e instanceof _.bq ||
          ((e =
            e.fromLatLngToPoint(new _.fk(0, 180)).x -
            e.fromLatLngToPoint(new _.fk(0, -180)).x),
          (this.ah.Gj = new _.wha({ Ws: new _.vha(e), ou: void 0 })));
      });
    }
    ...
    getWorldWidth() {
      return this.scale
        ? this.scale.Eg
          ? 256 * Math.pow(2, _.hr(this.scale))
          : _.gr(this.scale, new _.wm(256, 256)).hh
    ...
    getVisibleRegion() {
      ...
      const a = this.fromContainerPixelToLatLng(new _.wl(0, 0)),
        ...
        c = this.fromContainerPixelToLatLng(new _.wl(this.size.hh, 0)),
        d = this.fromContainerPixelToLatLng(
          new _.wl(this.size.hh, this.size.kh)
        ),
  ...
  _.sy = class {
    constructor(a, b, c) {
      ...
      this.ph = [];
      this.ph.push(
        new _.Vm(b, "mouseout", (d) => {
          this.ss(d);
        })
      );
      this.ph.push(
        new _.Vm(b, "mouseover", (d) => {
          this.us(d);
        })
      );
    }
    ss(a) {
      _.Nq(a) ||
        (this.Eg = _.dj(this.Hg, a.relatedTarget || a.toElement)) ||
        this.Fg.ss(a);
    }
    us(a) {
  ...
  var cka = class {
      ...
      Fk(a) {
        !this.wi.Fk || Qt(a) || a.Eg.__gm_internal__noUp || this.wi.Fk(a);
        Wt(this, this.Fg.Fk(a));
      }
      Ll(a) {
        const b = Qt(a) || _.ns(a.Eg);
        this.wi.Ll && !b && this.wi.Ll({ event: a, coords: a.coords, Hq: !1 });
      }
      Pt(a) {
        !this.wi.Pt ||
          Qt(a) ||
    ...
    uy = class {
      ...
      lk(a) {
        return Qt(a) ? new Yt(this.Eg) : new Ioa(this.Eg, !1, a.button);
      }
      ol() {}
      Fk() {}
      Ml() {}
    ...
    Ioa = class {
      ...
      Fk(a) {
        ...
        this.Eg.wi.Ll &&
          !b &&
          this.Eg.wi.Ll({ event: a, coords: this.Fg, Hq: this.Hg });
        this.Eg.wi.hC && a.Fg && a.Fg();
        return this.Hg || b
          ? new uy(this.Eg)
          : new Joa(this.Eg, this.Fg, this.Ig);
      }
      Ml() {}
      Oq() {
        if (this.Eg.wi.HK && this.Ig !== 3 && this.Eg.wi.HK(this.Fg))
          return new Yt(this.Eg);
      }
    },
    Yt = class {
      constructor(a) {
    ...
    Joa = class {
      ...
      lk(a) {
        ...
        !b && this.Eg.wi.bB && this.Eg.wi.bB(this.Hg, this.Fg);
        return Qt(a) ? new Yt(this.Eg) : new Ioa(this.Eg, b, a.button);
      }
      ol() {}
      Fk() {}
      Oq() {
        this.Eg.wi.bB && this.Eg.wi.bB(this.Hg, this.Fg);
  ...
  var Loa = {
      sx: "pointerdown",
      move: "pointermove",
      ZF: ["pointerup", "pointercancel"],
    },
    Moa = {
      sx: "MSPointerDown",
      move: "MSPointerMove",
      ZF: ["MSPointerUp", "MSPointerCancel"],
    },
    bu = -1e4,
    eka = class {
      constructor(a, b, c = a) {
          ...
          (d) => {
            au(d) &&
              ...
              this.Eg ||
                _.Nq(d) ||
                ($t(this),
                (this.Eg = new Noa(this, this.Kg, d)),
                this.Kg.lk(new _.Zt(d, d, 1))));
          },
          { Cl: !1 }
        );
        this.Ig = null;
    ...
    Noa = class {
      constructor(a, b, c) {
        ...
        this.Jg = [
          ...
          ...a.ZF.map(
            (d) => new _.Vm(document, d, (e) => aka(this, e), { Cl: !0 })
          ),
        ];
        this.Eg = new Koa();
        this.Eg.add(c);
    ...
    Ooa = class {
      constructor(a, b, c, d) {
        ...
        this.Jg = [
          ...
          new _.Vm(
            ...
            (e) => {
              a: {
                ...
                this.Ig.ol(new _.Zt(e, e.changedTouches[0], 1));
                e = void 0;
              }
              return e;
            },
          ...
          new _.Vm(document, "touchend", (e) => bka(this, e), {
            Cl: !0,
            passive: !1,
          }),
        ];
  ...
  var fka = class {
        ...
        this.Pg = new _.Vm(
          ...
          (d) => {
            ...
            _.Nq(d) ||
              ...
              (this.Hg instanceof eka && $t(this.Hg),
              (this.Eg = new Poa(this, this.Fg, d)),
              this.Fg.lk(new _.Zt(d, d, du(d))));
          },
          { Cl: !1 }
        );
        this.Kg = new _.Vm(
          ...
          (d) => {
            if (!_.Nq(d) && !this.Ig) {
              ...
              e < this.Hg.Jg() + 200 ||
                (e - this.Jg <= 300
                  ? (this.Jg = 0)
                  : ((this.Jg = e), this.Fg.Ll(new _.Zt(d, d, du(d)))));
            }
          },
          { Cl: !1 }
        );
        this.Ng = new _.Vm(
          ...
          (d) => {
            if (!(_.Nq(d) || this.Ig || Date.now() < this.Hg.Jg() + 200)) {
              ...
              e.wi.Ll && !f && e.wi.Ll({ event: d, coords: d.coords, Hq: !0 });
            }
          },
          { Cl: !1 }
        );
    ...
    Poa = class {
      constructor(a, b, c) {
        ...
        this.Kg = new _.Vm(a, "dragstart", _.pk);
  ...
  _.wy = class extends _.yq {
    constructor(a) {
      var b = _.ak(
        ...
        "element",
        () =>
          _.Yj(_.Rj(HTMLButtonElement, "HTMLButtonElement"))(a.element) ||
          _.gu(a.label || "\u0110\u00f3ng")
      );
      a = { ...a, element: b };
      super(a);
      ...
      a.ZB ||
        ...
        (this.element.style.top = _.ls(this.offset.y)),
        (this.element.style.right = _.ls(this.offset.x)));
      _.dn(
        this.element,
        new _.yl(this.Yr.width + 2 * this.Eq.x, this.Yr.height + 2 * this.Eq.y)
      );
  ...
  _.Woa = class {
    ...
    getTile(a, b, c) {
      ...
      c.Wj = { oh: c, ki: new _.wl(a.x, a.y), zoom: b, data: new _.Rm() };
  ...
  _.zy = new _.yy({ hh: 256, kh: 256 }, 0, 0);
  var Xoa, Yoa;
  ...
  _.Ay = class {
    constructor(a, b) {
      ...
      this.Dh =
        b || (Xoa.equals(a.tileSize) ? _.zy : new _.yy({ hh: c, kh: d }, 0, 0));
    }
    Mk(a, b) {
  ...
  var ou = new WeakMap(),
    jka = class {
      constructor({ ki: a, Zg: b, Qs: c, Dh: d }) {
        this.Eg = null;
        this.Ux = !1;
        this.isActive = !0;
        this.ki = a;
      ...
      Wh(a, b, c, d) {
        ...
        if (e) {
          ...
          (b.equals(k.scale) && a.equals(k.origin) && !m) ||
            ...
            (k.size = d),
            b.Eg
              ? ((f = _.dr(_.iu(f, k.Eg), a)),
                (h = Math.pow(2, _.hr(b) - k.Ah)),
                (b = b.Eg.bE(_.hr(b), b.tilt, b.heading, d, f, h, h)))
              : ((d = _.fr(_.gr(b, _.dr(_.iu(f, k.Eg), a)))),
                (a = _.gr(b, _.iu(f, { qh: 0, rh: 0, Ah: h }))),
                (m = _.gr(b, _.iu(f, { qh: 0, rh: 1, Ah: h }))),
                (b = _.gr(b, _.iu(f, { qh: 1, rh: 0, Ah: h }))),
                (b = `matrix(${(b.hh - a.hh) / g.hh},${(b.kh - a.kh) / g.hh},${
                  (m.hh - a.hh) / g.kh
                },${(m.kh - a.kh) / g.kh},${d.hh},${d.kh})`)),
            (k.oh.style[_.mu()] = b));
          ...
          c.top = String(g.kh * (this.ki.rh - k.rh)) + "px";
          c.width = `${g.hh}px`;
          c.height = `${g.kh}px`;
        }
      }
    ...
    kka = class {
      ...
      pl(a) {
        a.parentNode === this.oh &&
          (this.oh.removeChild(a),
          this.oh.hasChildNodes() || ((this.Eg = null), _.cj(this.oh)));
      }
    };
  var By = class {
    constructor(a, b, c) {
  ...
  _.Cy = class {
    constructor(a, b, c, d, e, { wx: f = !1 } = {}) {
      ...
      this.wx = f && "transition" in this.Fg.style;
      this.Og = d.kl !== 1;
    }
    freeze() {
      this.isActive = !1;
    ...
    Wh(a, b, c, d, e, f, g, h) {
      d =
        ...
        (!!c.Eg && this.size && !_.ys(g, this.size));
      this.origin = b;
      this.scale = c;
      this.hint = h;
      this.size = g;
      ...
      m = (this.Ig.kl === 1 && e && this.ah.Yz(e)) || a;
      k = this.Ig.Dh;
  ...
  var ela = [[_.Qo, qt, 3], 1, [_.Jv, _.O], _.Qo, [_.N, _.Eu, _.Q]];
  var epa = [
    "znXjDg",
    _.uv,
    30,
  ...
  var fla = [
    ...
    [_.N, , , _.ht, ,],
    _.Qo,
    [_.pt, _.N, 1, _.Dy, 1, [_.ht, _.N], [_.Q, _.N]],
    [
      _.Uo,
      [_.Q, _.vt],
      ,
  ...
  ypa = [
    ...
    [
      ...
      [
        ...
        [
          [
            [_.U, _.ht, _.st, _.U, _.Q, _.U, _.Uo, _.O, _.Q, ,],
            _.wv,
            ,
            _.Qo,
            [_.O, [_.pt, _.ht], 1, _.U, _.pt, 1, _.O, ,],
            _.Q,
          ],
        ],
      ],
  ...
  _.cw = class {
    ...
    toString() {
      return `${this.Mn()};${
        this.spotlightDescription && _.Ai(this.spotlightDescription, _.Xv(), 1)
      };${this.yn && this.yn.join()};${
        this.searchPipeMetadata && _.Ai(this.searchPipeMetadata, Kja(), 1)
      };${
        this.gmmContextPipeMetadata && _.Ai(this.gmmContextPipeMetadata, sna, 1)
      };${this.travelMapRequest && _.Ai(this.travelMapRequest, ypa, 1)};${
        this.airQualityPipeMetadata && _.Ai(this.airQualityPipeMetadata, cpa, 1)
      };${
        this.directionsPipeParameters &&
        _.Ai(this.directionsPipeParameters, cla(), 1)
      };${
        this.caseExperimentIds &&
        _.cs(this.caseExperimentIds, (a) => String(a)).join(",")
      };${this.boostMapExperimentIds && this.boostMapExperimentIds.join(",")};${
        this.clientSignalPipeMetadata &&
        _.Ai(this.clientSignalPipeMetadata, $ma, 1)
      }`;
    }
    Mn() {
      let a = [];
  ...
  _.Apa = class {
    ...
    Rn() {
      ...
      if (_.H(_.Xq(this.Eg).Gg, 4) === 0) {
        var a =
          `The map ID "${_.L(this.Eg.Gg, 1)}" is not configured. ` +
          "Map capabilities remain available.";
        _.nk(a);
        return !0;
      }
      _.H(_.Xq(this.Eg).Gg, 4) === 1 &&
        ((a =
          `The map ID "${_.L(this.Eg.Gg, 1)}" is not configured. ` +
  ...
  var rla = class extends _.Lga {
    ...
    Nq() {
      this.Eg ||
        (this.Eg = this.Ig.addListener(
          (this.Fg + "").toLowerCase() + "_changed",
          () => {
            this.Hg && this.notify();
          }
        ));
  ...
  Dla = [
    _.Qo,
    [_.rt, _.Q, _.To, _.N, _.To, _.pt, _.U, _.O, 1, , _.Q, , 1, , _.N, _.Q],
    ,
    [Px, _.To, _.ht, _.U, _.wv, _.Q],
    _.Uo,
    _.Qo,
    [_.rt, _.ht, _.To, _.ht, _.To],
  ];
  var Iw;
  ...
  var zla = class extends _.W {
    ...
    Fla = [
      ...
      [Ky, Ky, _.O],
      1,
      [Ky, _.To, _.rt, _.Qo, _.rt, _.rt, _.rt, _.To, ,],
      [_.O, ,],
      1,
      [_.gy, _.O, Kma],
      1,
  ...
  _.My = class {
    ...
    Ii(a, b, c = !0) {
      ...
      a.searchPipeMetadata &&
        _.Ss(_.Gw(this.request), _.nna, a.searchPipeMetadata);
      a.gmmContextPipeMetadata &&
        _.Ss(_.Gw(this.request), tna, a.gmmContextPipeMetadata);
      a.airQualityPipeMetadata &&
        _.Ss(_.Gw(this.request), dpa, a.airQualityPipeMetadata);
      a.directionsPipeParameters &&
        _.Ss(_.Gw(this.request), apa, a.directionsPipeParameters);
      a.clientSignalPipeMetadata &&
        _.Ss(_.Gw(this.request), _.ana, a.clientSignalPipeMetadata);
      a.layerId &&
        (_.xla(a, !0, _.Bw(this.request)), c && (a = a.Ct(b)) && _.Pw(this, a));
    }
  };
  _.Bpa = class extends _.Iq {
    constructor() {
      var a = _.ffa;
      super({ ["X-Goog-Maps-Client-Id"]: _.Ni?.Hg() || "" });
      this.Fg = a;
    }
    async intercept(a, b) {
      const c = this.Fg();
  ...
  _.Ny = class {
    constructor(a = [new _.Iq()]) {
      this.Eg = new Qja(this.Fg(), { withCredentials: !1, NF: !1, pC: a });
    }
    Fg() {
      return _.iy;
    }
  ...
  _.kma = class {
    constructor(a, b, c) {
      ...
      this.Fg = c;
      this.Hg = {};
      for (a = 0; a < _.vi(_.Ni.Gg, 42); ++a)
        (b = _.Tq(_.Ni.Gg, 42, _.px, a)), (this.Hg[_.L(b.Gg, 1)] = b);
    }
  };
  var Dpa;
  _.Oy = class {
    ...
    async setUrl(a) {
      if (a !== this.url || this.Jg)
        (this.url = a),
          ...
          a
            ? ((this.Eg = new Dpa(this.oh, this.Kg(), this.size, a)),
    ...
    dispose() {
      this.Fg
        ? ((this.Fg = !1),
          ...
          (this.Eg.src = _.oy))
        : this.Eg.parentNode && this.oh.removeChild(this.Eg);
    }
  };
  var Epa;
  Epa = class {
    ...
    Ig() {
      ...
      if (a && a.Lm) {
        ...
        if (b) {
          ...
          if (c)
            for (let h = 0, k = _.zw(d.request); h < k; h++)
              (g = _.Aw(d.request, h)), g.getType() === 0 && _.mw(g, c);
          typeof this.heading === "number" &&
            (_.Gi(d.request.Gg, 13, this.heading), _.Di(d.request.Gg, 14, !0));
          c = null;
          this.Hg &&
            this.Hg.Zs !== null &&
            ((c = this.Hg.Zs),
            (c = c.Eg && _.Wq(c.Eg) && c.Rn() ? _.L(_.Xq(c.Eg).Gg, 6) : ""));
          b = c ? c : _.lma(this.Lg, b);
          b += `pb=${encodeURIComponent(_.xw(d.request, 0)).replace(
            /%20/g,
            "+"
          )}`;
  ...
  _.Py = class {
    constructor(a, b, c, d, e, f, g, h, k, m = !1) {
      ...
      this.Dh = new _.yy({ hh: 256, kh: 256 }, _.yj(g) ? 45 : 0, g || 0);
    }
    Mk(a, b) {
      const c = _.aj("DIV");
  ...
  _.Fpa = class extends _.Ik {
    constructor(a) {
      ...
      Fs(this.Eg, { fontFamily: "Roboto,Arial,sans-serif" });
      this.Hg();
      this.get("fontLoaded") || this.set("fontLoaded", !1);
    }
    Hg() {
      this.Eg.offsetWidth !== this.Ig
        ? (this.set("fontLoaded", !0), _.cj(this.Fg))
    ...
    constructor(a) {
      ...
      this.Hg = pja((f) => {
        ...
        a(g, (h) => {
          ...
          if (!k) {
            _.Sw();
            let m = _.Y(_.J(h.Gg, 6, _.jn).Gg, 3)
              ? _.L(_.J(h.Gg, 6, _.jn).Gg, 3)
              : _.Qw();
            h = _.H(h.Gg, 2, -1);
            if (h === 0 || h === 13) {
  ...
  var Ipa = class {
    constructor(a) {
      ...
      _.Ni && _.Y(_.Ni.Gg, 40)
        ? (a = _.J(_.Ni.Gg, 40, _.jn))
        : ((a = new _.jn()), _.Gi(a.Gg, 1, 1));
      this.Hg = _.Gl(a, !1);
      _.br(this.Hg, (g) => {
  ...
  _.Xy =
    ...
    (_.Ni ? ["/intl/", _.Ni.Eg().Eg(), "_", _.Ni.Eg().Fg()].join("") : "") +
    "/help/terms_maps.html";
  _.Sy = new Hpa((a, b) => {
    _.lx(
      _.ho,
      _.iy + "/maps/api/js/AuthenticationService.Authenticate",
      _.go,
      _.Ai(a, Gpa, 1),
      (c) => {
        c = new Jpa(c);
  ...
  _.Mpa = new Ipa((a, b) => {
    _.lx(
      _.ho,
      Eoa + "/maps/api/js/QuotaService.RecordEvent",
      _.go,
      _.Ai(a, Aoa, 1),
      (c) => {
        c = new Boa(c);
  ...
  _.Wpa = class {
    constructor(a) {
      ...
      if ((d = a.backgroundColor) || !b.style.backgroundColor)
        b.style.backgroundColor = d || (a.uE ? "#202124" : "#e5e3df");
      c.style.overflow = "hidden";
      c = _.aj("DIV");
      d = _.aj("DIV");
      const e = a.cG ? _.aj("DIV") : d;
      ...
      a.rD &&
        ((this.Iq = _.aj("DIV")),
        (this.Iq.style.zIndex = 3),
        d.appendChild(this.Iq),
        nx(this.Iq),
        (this.Fg = _.aj("DIV")),
        ...
        nx(this.Fg),
        (this.Fo = _.aj("DIV")),
        (this.Fo.style.zIndex = 4),
        a.YB
          ? (this.Iq.appendChild(this.Fo), vma(this.Fo))
          : (d.appendChild(this.Fo),
            (this.Fo.style.position = "absolute"),
            (this.Fo.style.left = this.Fo.style.top = "0"),
            (this.Fo.style.width = "100%")));
      this.Pn = d;
      this.Eg = c;
      this.Tj = e;
  ...
  _.Xpa = class {
    ...
    Wh(a, b, c, d, e, f, g, h) {
      ...
      if (c.Eg) {
        ...
        (d = _.fr(_.gr(c, b))),
          (e = _.gr(c, a)),
          (g = _.gr(c, new _.wm(f.Eg, a.Fg))),
          (c = _.gr(c, new _.wm(a.Eg, f.Fg))),
          (c =
            "matrix(" +
            String((g.hh - e.hh) / this.Fg.width) +
            "," +
            String((g.kh - e.kh) / this.Fg.width) +
            "," +
            String((c.hh - e.hh) / this.Fg.height) +
            "," +
            String((c.kh - e.kh) / this.Fg.height) +
            "," +
            String(d.hh) +
            "," +
            String(d.kh) +
  ...
  _.Ypa = class extends _.Ik {
    ...
    getWorldWidth() {
      return _.xs(this.get("projection"), this.get("zoom"));
    }
    getVisibleRegion() {
      return null;
    }
  ...
  _.hz = class {
    ...
    Gx() {
      return this.feature.Gx();
    }
  };
  _.hz.prototype.getLegendaryTags = _.hz.prototype.Gx;
