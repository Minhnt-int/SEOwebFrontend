google.maps.__gjsload__("controls", function (_) {
  ...
  tL = function (a, b) {
    ...
    const d = [];
    for (let e = 0, f = _.sj(b.padding); e < f; ++e)
      d.push(_.ls(c * b.padding[e]));
    a.padding = d.join(" ");
  ...
  HJa = function (a, b) {
    ...
    if (!c) {
      ...
      c = d;
      a.style[d] === void 0 &&
        ((d = _.HE() + _.CAa(d)), a.style[d] !== void 0 && (c = d));
      GJa[b] = c;
    }
    return c;
  };
  uL = function (a, b, c) {
    if (typeof b === "string") (b = HJa(a, b)) && (a.style[b] = c);
    else
      for (var d in b) {
        c = a;
        var e = b[d],
  ...
  JJa = function (a) {
    a = IJa(a, "hybrid", "satellite", "labels", "Nh\u00e3n");
    a.set("enabled", !0);
    return a;
  };
  IJa = function (a, b, c, d, e, f) {
    const g = a.Ig.get(b);
    e = new KJa(e || g.name, g.alt, d, !0, !1, f);
    a.mapping[b] = { mapTypeId: c, Xv: d, value: !0 };
    a.mapping[c] = { mapTypeId: c, Xv: d, value: !1 };
    return e;
  };
  LJa = function (a, b, c) {
    const d = _.gu(a === 0 ? "Ph\u00f3ng to" : "Thu nh\u1ecf");
  ...
  yL = function (a, b, c, d) {
    ...
    b =
      b === 0
        ? d === 2
          ? [
              _.py["zoom_in_normal_dark.svg"],
              _.py["zoom_in_hover_dark.svg"],
              _.py["zoom_in_active_dark.svg"],
              _.py["zoom_in_disable_dark.svg"],
            ]
          : [
              _.py["zoom_in_normal.svg"],
              _.py["zoom_in_hover.svg"],
              _.py["zoom_in_active.svg"],
              _.py["zoom_in_disable.svg"],
            ]
        : d === 2
        ? [
            _.py["zoom_out_normal_dark.svg"],
            _.py["zoom_out_hover_dark.svg"],
            _.py["zoom_out_active_dark.svg"],
            _.py["zoom_out_disable_dark.svg"],
          ]
        : [
            _.py["zoom_out_normal.svg"],
            _.py["zoom_out_hover.svg"],
            _.py["zoom_out_active.svg"],
            _.py["zoom_out_disable.svg"],
          ];
    for (const e of b)
      (b = document.createElement("img")),
        (b.style.width = b.style.height = `${wL(c)}px`),
        (b.src = e),
        (b.alt = ""),
        a.appendChild(b);
  };
  ...
  BL = function (a, b) {
    ...
    c.addEventListener("click", (d) => {
      switch (b) {
        case "Down":
          _.Fk(a, "panbyfraction", 0, 0.5);
          break;
        case "Left":
          _.Fk(a, "panbyfraction", -0.5, 0);
          break;
        case "Right":
          _.Fk(a, "panbyfraction", 0.5, 0);
          break;
  ...
  NJa = function (a, b) {
    const c = LJa(b, a.controlSize, a.Ig);
    zL(a, c);
    c.style.position = "absolute";
  ...
  AL = function (a, b, c) {
    ...
    DL(
      a,
      [
        _.py[`camera_move_${c.toLowerCase()}${d}.svg`],
        _.py[`camera_move_${c.toLowerCase()}_hover${d}.svg`],
        _.py[`camera_move_${c.toLowerCase()}_active${d}.svg`],
        _.py[`camera_move_${c.toLowerCase()}_disable${d}.svg`],
      ],
      b
    );
  };
  ...
  SJa = function (a, b) {
    ...
    UJa(a, a.progress);
    a.progress == 1
      ? ((a.Eg = 0), GL(a), a.Fn("finish"), a.Fn("end"))
      : a.Eg == 1 && a.Fn("animate");
  };
  UJa = function (a, b) {
  ...
  KL = function (a, b, c, d) {
    ...
    b = b
      ? d === 2
        ? [
            _.py["fullscreen_exit_normal_dark.svg"],
            _.py["fullscreen_exit_hover_dark.svg"],
            _.py["fullscreen_exit_active_dark.svg"],
          ]
        : [
            _.py["fullscreen_exit_normal.svg"],
            _.py["fullscreen_exit_hover.svg"],
            _.py["fullscreen_exit_active.svg"],
          ]
      : d === 2
      ? [
          _.py["fullscreen_enter_normal_dark.svg"],
          _.py["fullscreen_enter_hover_dark.svg"],
          _.py["fullscreen_enter_active_dark.svg"],
        ]
      : [
          _.py["fullscreen_enter_normal.svg"],
          _.py["fullscreen_enter_hover.svg"],
          _.py["fullscreen_enter_active.svg"],
        ];
    for (const e of b)
      (b = document.createElement("img")),
        (b.style.width = b.style.height = _.ls(wL(c))),
        (b.src = e),
        (b.alt = ""),
        a.appendChild(b);
  };
  ...
  LL = function (a, b) {
    a.Eg.style.backgroundColor = aKa[b].backgroundColor;
  ...
  NL = function (a) {
    a.oj &&
      ((a.oj.style.backgroundColor = "#000"), (a.Ng.style.color = "#fff"));
  };
  OL = async function (a) {
    _.Fk(a.Zg, "resize");
  };
  cKa = function (a) {
    const b = _.gu("Ph\u00edm t\u1eaft");
    a.Zg.appendChild(b);
    _.Js(b, 1000002);
  ...
  SL = function (a, b) {
    ...
    for (const { element: h, width: k } of a.elements)
      rL(h) && h.style.visibility !== "hidden" && (c = Math.max(c, k));
    let d = 0,
      e = !1;
    const f = a.padding;
  ...
  kKa = function (a, b, c, d) {
    function e() {
      const h = g.get("hasCustomStyles"),
        k = a.getMapTypeId(),
        m = d === 2;
      iKa(f, h || k === "satellite" || k === "hybrid" || m);
    }
    const f = new jKa(a, b, c),
      g = a.__gm;
  ...
  iKa = function (a, b) {
    _.RG(
      a.Mg,
      b ? _.py["google_logo_white.svg"] : _.py["google_logo_color.svg"]
    );
  };
  lKa = function (a) {
  ...
  nKa = function (a, b) {
    a.Eg.style.backgroundColor = a.zi
      ? b
        ? "#666"
        : "#444"
      : b
  ...
  sKa = function (a) {
    ...
    if (!b.ph) {
      ...
      a.shadowRoot
        ? (b.ph.push(
            _.zk(a.shadowRoot, "click", (d) => {
              a.Zg.contains(d.target) || a.set("active", !1);
            })
          ),
          b.ph.push(
            _.zk(document.body, "click", (d) => {
  ...
  xKa = function (a, b, c, d) {
    ...
    const k = _.en(f);
    b.Fg &&
      ((h = new vKa(a, f, b.Fg, a.Fg, g.Ei(), {
        position: new _.wl(d ? 0 : c, k.height),
        tL: d,
        zi: e,
      })),
      wKa(f, g, h));
    a.Eg.push({ parentNode: f, tq: h });
    return (c += k.width);
  };
  wKa = function (a, b, c) {
    new _.Vm(a, "click", () => {
  ...
  CKa = function (a) {
    ...
    a = a.get("mapTypeId");
    return b && _.hBa(a) && c && !_.Ns();
  };
  DKa = function (a, b, c) {
    a.innerText = "";
    b = b
      ? [
          _.py["tilt_45_normal.svg"],
          _.py["tilt_45_hover.svg"],
          _.py["tilt_45_active.svg"],
        ]
      : [
          _.py["tilt_0_normal.svg"],
          _.py["tilt_0_hover.svg"],
          _.py["tilt_0_active.svg"],
        ];
    for (const d of b)
      (b = document.createElement("img")),
        (b.alt = ""),
        (b.style.width = _.ls(wL(c))),
        (b.src = d),
        a.appendChild(b);
  };
  EKa = function (a, b, c) {
    var d = [
      _.py["rotate_right_normal.svg"],
      _.py["rotate_right_hover.svg"],
      _.py["rotate_right_active.svg"],
    ];
    for (const e of d) {
  ...
  ZL = function (a) {
    ...
    b &&
      ((b *= 80),
      (b = a.Jg ? IKa(b / 1e3, b, !0) : IKa(b / 1609.344, b * 3.28084, !1)),
      (a.Ig.textContent = b.Ir + "\u00a0"),
      a.Zg.setAttribute("aria-label", b.BE),
      (a.Zg.title = b.BE),
      (a.Eg.style.width = _.IE(b.ZK + 4, !0)),
      _.Fk(a.Zg, "resize"));
  };
  IKa = function (a, b, c) {
    var d = a;
  ...
  fLa = function (a) {
    ...
    if (a.visible) {
      ...
      d.style.left = "50%";
      d.style.top = "50%";
      d.append(a.Fg.vA, a.Fg.active, a.Fg.uA);
  ...
  pLa = function (a) {
    ...
    if (_.vJ(b)) {
      ...
      b === 7
        ...
        : (c = null);
    c
      ? (a.Ig.firstChild.__src__ !== c.url && _.RG(a.Ig.firstChild, c.url),
        _.TG(a.Ig, c.size || null, c.origin || null, c.scaledSize),
        c.size &&
  ...
  wLa = function (a, b, c) {
    ...
    const f = new _.nK(["mapHeading", "streetviewHeading"], "heading", tLa);
  ...
  uLa = async function (a) {
    var b = await _.kj("streetview");
    if (!a.Eg) {
      var c = a.map.__gm,
        d = (0, _.Da)(a.Kg.getUrl, a.Kg),
        e = c.get("panes");
      a.Eg = new b.OG(e.floatPane, d, a.config);
  ...
  ALa = function (a) {
    if (!_.an[2]) {
      var b = !!_.an[21];
      a.Eg
        ? (b = kKa(a.Eg, a.pi, b, a.Ug))
        : ((b = new jKa(a.Fg, a.pi, b)), iKa(b, !0));
      b = b.getDiv();
  ...
  DLa = function (a) {
    const b = new BLa(a.Yg, a.Lg, a.Oh, a.si, a.Tg);
    b.bindTo("size", a);
    b.bindTo("rmiWidth", a);
  ...
  HLa = function (a) {
    if (a.Eg) {
      ...
      a.dh = new GLa(
        ...
        _.ML(b, a.Lg, a.Tg),
        new _.ry(
          [_.jw(a, "projection"), _.jw(a, "bottomRight"), _.jw(a, "zoom")],
          _.qDa
        ),
        a.Tg
      );
  ...
  JLa = function (a) {
    if (a.Eg) {
      ...
      a.Jg = new ILa(c, a.Eg, _.L(b.Gg, 15), a.Tg);
  ...
  LLa = function (a) {
    a.Vg && (a.Vg.unbindAll(), $Ja(a.Vg), (a.Vg = null), a.Hg.pl(a.Ai));
    const b = _.gu(
        "Chuy\u1ec3n \u0111\u1ed5i ch\u1ebf \u0111\u1ed9 xem to\u00e0n m\u00e0n h\u00ecnh"
      ),
      c = new KLa(a.Lg, b, a.tk, a.Kg, a.Ug);
  ...
  iMa = function (a) {
    a.Qg && (UKa(a.Qg), a.Qg.unbindAll(), (a.Qg = null));
    a.Ig && (a.Ig = null);
    a.Ng && (a.Ng.unbindAll(), (a.Ng = null));
    a.lh && (a.lh.unbindAll(), (a.lh = null));
    for (var b of a.Ih) VLa(a, b);
    a.Ih = [];
    a.Hg &&
      _.Ck(a.Hg, "isrtl_changed", () => {
        gM(a);
      });
    b = a.nj = WLa(a);
    var c = (a.Wi = XLa(a)),
    ...
    g = (p, t) => {
      ...
      if (!m[u]) {
        ...
        u === 10 || u === 11 || u === 12 || u === 6 || u === 9
          ...
          : _.qL(z, "gm-bundled-control-on-bottom");
    ...
    e &&
      (cMa(a),
      g(e, a.di),
      a.Og && a.Hg && a.Og.set("isOnLeft", c.includes(RL(a.Hg, e))));
    k && ((e = c.includes(RL(a.Hg, k))), (e = dMa(a, e)), g(k, e));
    h && a.Fg && _.As().transform && ((e = eMa(a)), g(h, e));
    f && ((h = fMa(a)), g(f, h));
    a.Wg && (a.Wg.remove(), (a.Wg = null));
    if ((h = gMa(a) && 22)) (e = hMa(a)), g(h, e);
    ...
    if (a.Uh && !a.Jh) {
      ...
      if (b) {
        ...
        var d = a.get("mapTypeControlOptions") || {},
          e = (a.gh = new kMa(a.Uh, d.mapTypeIds));
        ...
        d = null;
        b == 2
          ? ((d = new lMa(c, f, a.Kg, a.Ug)), e.bindTo("mapTypeId", d))
          : (d = new mMa(c, f, a.Kg, a.Ug));
        b = a.zh = new nMa(e.mapping);
        b.set("labels", !0);
  ...
  TLa = function (a) {
    ...
    a.Xg && (VLa(a, a.Xg), _.vn(a.Xg.oh), (a.Xg = null));
  };
  YLa = function (a) {
    const b = a.get("zoomControl"),
      c = iM(a);
    return b == 0 || (c && b === void 0)
      ? (a.Fg || (_.ql(a.Eg, "Czn"), _.M(a.Eg, 148262)), null)
      : a.get("size")
      ? 1
      : null;
  };
  ...
  WLa = function (a) {
    ...
    if (b !== void 0 || c)
      return (
        a.Fg || (_.ql(a.Eg, b ? "Cpy" : "Cpn"), _.M(a.Eg, b ? 148255 : 148254)),
        !!b
      );
    b = a.get("size");
  ...
  ZLa = function (a) {
    const b = a.get("rotateControl"),
      c = iM(a);
    if (b !== void 0 || c)
      _.ql(a.Eg, b ? "Cry" : "Crn"), _.M(a.Eg, b ? 148257 : 148256);
  ...
  hM = function (a) {
    ...
    const c = a.get("disableDefaultUI"),
      d = !!a.get("size");
    if (b !== void 0 || c)
      _.ql(a.Eg, b ? "Cvy" : "Cvn"), _.M(a.Eg, b ? 148260 : 148261);
    b == null && (b = !c);
    a = d && !a.Fg;
    return b && a;
  };
  ...
  fM = function (a) {
    if (a.dh) {
      ...
      b !== void 0 &&
        (_.ql(a.Eg, b ? "Csy" : "Csn"), _.M(a.Eg, b ? 148259 : 148258));
  ...
  VLa = function (a, b) {
    b.ay ? (b.ay.remove(b.oh), delete b.ay) : a.Hg.pl(b.oh);
  };
  jMa = function (a) {
    if (!a.Uh) return null;
    ...
    if ((c === void 0 && d) || (c !== void 0 && !c))
      return _.ql(a.Eg, "Cmn"), _.M(a.Eg, 148251), null;
    b == 1
      ? (_.ql(a.Eg, "Cmh"), _.M(a.Eg, 148253))
      : b == 2 && (_.ql(a.Eg, "Cmd"), _.M(a.Eg, 148252));
    return b == 2 || b == 1 ? b : 1;
  };
  bMa = function (a) {
    const b = (a.Qg = new qMa(a.Kg, a.Lg, a.Ug));
  ...
  dMa = function (a, b = !1) {
    a.Ig = new rMa({ controlSize: a.Kg, xv: b, Ep: a.Lg });
  ...
  eMa = function (a) {
    const b = new _.SK(aM, { Xq: _.Uy.Dj() }),
      c = new sMa(b, a.Kg, a.Lg);
    c.bindTo("pov", a);
    c.bindTo("disableDefaultUI", a);
  ...
  AMa = function (a, b, c, d, e, f, g, h, k, m, p, t, u, w, x, z, B, D) {
    ...
    if (F && k) {
      ...
      _.Dk(b, "idle", () => {
        var C = b.get("bounds");
        C != V && (I.set("bounds", C), T.set("bounds", C), (V = C));
        C = b.get("center");
  ...
  HMa = function (a, b, c, d, e, f) {
    const g = new FMa(b, e, f);
    g.bindTo("zoom", a);
  ...
  GMa = function (a, b, c, d) {
    const e = new _.RK({ mp: d, np: c, ownerElement: b, lw: !1, Vs: "map" });
    _.Dk(a, "keyboardshortcuts_changed", () => {
      _.kr(a) ? b.append(e.element) : e.element.remove();
    });
  };
  IMa = () => _.Nha.some((a) => !!document[a]);
  GJa = {};
  KJa = class extends _.Ik {
      ...
      for (const e of b) {
        ...
        e === "roadmap"
          ...
          : (e !== "satellite" && e !== "hybrid") ||
            !d ||
            ((this.Fg = JJa(this)), (f = [[this.Fg]]));
        this.buttons.push(
          new KJa(b.name, b.alt, "mapTypeId", e, null, null, f)
        );
      }
    }
  };
  ...
  var rMa = class extends HTMLElement {
    constructor(a = { controlSize: 40, xv: !1 }) {
      super();
      this.Fg = this.Qg = !1;
      this.Hg = _.gu(
    ...
    connectedCallback() {
      if (!this.Qg) {
        ...
        DL(
          this,
          [
            _.py[`camera_control${a}.svg`],
            _.py[`camera_control_hover${a}.svg`],
            _.py[`camera_control_active${a}.svg`],
            _.py[`camera_control_disable${a}.svg`],
          ],
          this.Hg
        );
        this.Hg.type = "button";
    ...
    Tg(a) {
      ...
      if (this.Ig !== a) {
        ...
        DL(
          this,
          [
            _.py[`camera_control${b}.svg`],
            _.py[`camera_control_hover${b}.svg`],
            _.py[`camera_control_active${b}.svg`],
            _.py[`camera_control_disable${b}.svg`],
          ],
          this.Hg
        );
  ...
  _.Tl("gmp-internal-camera-control", rMa);
  var RLa = class extends _.Ik {
    constructor(a) {
      super();
      this.Zg = a;
      this.Eg = null;
  ...
  _.G.Fn = function (a) {
    this.dispatchEvent(new VJa(a, this));
  };
  _.Ia(VJa, _.Xf);
  var sMa = class extends _.Ik {
    ...
    changed() {
      ...
      if (a) {
        ...
        _.Ys(
          _.Ii(b.Gg, 4, _.KG),
          _.LG(_.TD(_.py["compass_needle_normal.svg"]))
        );
        _.Ys(_.Ii(b.Gg, 5, _.KG), _.LG(_.TD(_.py["compass_needle_hover.svg"])));
        _.Ys(
          _.Ii(b.Gg, 6, _.KG),
          _.LG(_.TD(_.py["compass_needle_active.svg"]))
        );
        _.Ys(
          _.Ii(b.Gg, 7, _.KG),
          _.LG(_.TD(_.py["compass_rotate_normal.svg"]))
        );
        _.Ys(_.Ii(b.Gg, 8, _.KG), _.LG(_.TD(_.py["compass_rotate_hover.svg"])));
        _.Ys(
          _.Ii(b.Gg, 9, _.KG),
          _.LG(_.TD(_.py["compass_rotate_active.svg"]))
        );
        _.Yg(
          b.Gg,
          10,
        ...
        _.Yg(b.Gg, 11, "Xoay theo chi\u1ec1u kim \u0111\u1ed3ng h\u1ed3");
        _.Yg(b.Gg, 12, "\u0110\u1eb7t l\u1ea1i ch\u1ebf \u0111\u1ed9 xem");
        this.layout.update([b]);
        this.layout.oh.style.setProperty(
    ...
    startAnimation(a, b, c, d) {
      ...
      a = this.animation = new IL([a, c], [b, d], 1200, WJa);
      zJa(e, a, (f) => {
        ZJa(this, !1, f);
      });
      _.Axa(e, a, "finish", (f) => {
  ...
  var KLa = class extends _.Ik {
      constructor(a, b, c, d, e = 1) {
        ...
        this.Fg &&
          ...
          (this.Eg.style.borderRadius = _.ls(_.IG(d))),
          (this.Eg.style.width = this.Eg.style.height = _.ls(d)),
          (this.Eg.style.boxShadow = "0 1px 4px -1px rgba(0,0,0,0.3)"),
          KL(this.Eg, this.Jl.get(), d, e),
          (this.Eg.style.overflow = "hidden"),
          _.zk(this.Eg, "click", (f) => {
    ...
    aKa = {
      [1]: { SI: -52, close: -78, top: -86, backgroundColor: "#fff" },
      [2]: { SI: 0, close: -26, top: -86, backgroundColor: "#444" },
    };
  var bKa = (0,
  ...
  var KMa = class extends _.Ik {
    constructor(a, b, c) {
      ...
      a = new Image();
      a.src = this.Fg
        ? _.py["keyboard_icon_dark.svg"]
        : _.py["keyboard_icon.svg"];
      a.alt = "";
      a.style.height = "9px";
    ...
    Jj() {
      this.get("keyboardShortcutsShown") ||
        ((this.Zg.style.display = "none"), _.Fk(this, "update"));
    }
    Gl() {
      return this.Zg;
    }
  ...
  var NLa = class extends _.Ik {
    constructor(a, b) {
      super();
      this.Fg = a;
      this.Hg = b;
      this.Zg = _.Is("div");
      this.element = cKa(this);
  ...
  var LMa = new Set([3, 12, 6, 9]),
    MMa = [1, 2, 3, 5, 7, 4, 13, 8, 6, 9, 10, 11, 12],
    NMa = [3, 2, 1, 7, 5, 8, 13, 4, 9, 6, 12, 11, 10],
    OMa = new Set([24, 23, 25, 19, 17, 18, 22, 21, 20, 15, 14, 16]),
    QMa = class extends _.Ik {
      constructor(a, b = !1) {
        super();
        this.Ig = a;
      ...
      addElement(a, b, c = !1, d) {
        ...
        if (f) {
          ...
          b = this.Eg.get(e);
          e = this.get("isRTL") ^ LMa.has(e) ? f.length - h - 1 : h;
      ...
      isRTL_changed() {
        if (this.Eg) {
          var a = this.get("isRTL") ? NMa : MMa;
          for (const b of a) this.Ig.appendChild(this.Eg.get(b));
          a = [...this.Fg];
          for (const b of a)
            this.pl(b.element), this.addElement(b.element, b.tE, b.Rv, b.HJ);
        }
      }
    },
    RMa = (a) => {
    ...
    oM = (a, b, c, d) => {
      ...
      for (const { Rv: g, element: h } of a) {
        ...
        b === "left"
          ? (h.style.left = "0")
          : b === "right"
          ? (h.style.right = _.ls(k - p))
          : (h.style.left = _.ls((c - p) / 2));
        e += m;
        g || (f = Math.max(k, f));
      }
      b = (d - e) / 2;
      for (const { element: g } of a)
        (g.style.top = _.ls(b)), (b += QL(g)), (g.style.visibility = "");
      return f;
    },
    PMa = (a, b, c) => {
      let d = 0,
        e = 0;
      for (const { Rv: f, element: g } of a) {
        const h = PL(g),
          k = QL(g),
          m = QL(g, !0);
      ...
      for (const { element: f } of a)
        (f.style.left = _.ls(b)), (b += PL(f)), (f.style.visibility = "");
      return e;
    };
  var aMa = class {
    constructor(a, b, c = 0) {
    ...
    add(a) {
      ...
      this.Eg
        ? this.Zg.insertBefore(a, this.Zg.firstChild)
        : this.Zg.appendChild(a);
      a = gKa(this, a);
    ...
    remove(a) {
      ...
      AJa(this.elements, (b, c) => {
        b.element === a && (this.elements.splice(c, 1), this.onRemove(b));
      });
    }
    onRemove(a) {
      a && (SL(this, a), a.CB && (_.vk(a.CB), delete a.CB));
    }
  };
  ...
  var mKa = class extends _.Ik {
    constructor(a, b, c, d) {
      ...
      d.JA ? pL(this.Eg) : (this.Fg.textAlign = "center");
      d.height &&
        ((this.Fg.height = _.ls(d.height)),
      ...
      d.MJ
        ? ((a = document.createElement("span")),
          (a.style.position = "relative"),
          _.Hs(a, new _.wl(3, 0), !_.Uy.Dj(), !0),
          a.appendChild(b),
          this.Eg.appendChild(a),
          (b = _.QG(_.Zn("arrow-down"), this.Eg)),
          _.Hs(b, new _.wl(8, 0), !_.Uy.Dj()),
          (b.style.top = "50%"),
          (b.style.marginTop = _.ls(-2)),
          this.set("active", !1),
      ...
      d.sJ && this.Eg.setAttribute("aria-haspopup", "true");
      d.XC && (this.Fg.fontWeight = "500");
      this.Hg = _.nE(this.Fg.paddingLeft) || 0;
      d.JA ||
        ((this.Fg.fontWeight = "500"),
        (d = this.Eg.offsetWidth - this.Hg - (_.nE(this.Fg.paddingRight) || 0)),
        (this.Fg.fontWeight = ""),
        _.yj(d) && d >= 0 && (this.Fg.minWidth = _.ls(d)));
  ...
  var UMa = class extends _.Ik {
    constructor(a, b, c, d) {
      ...
      _.Bk(this, "enabled_changed", this, () => {
        ...
        (f = f ? d?.title : d?.tI) && e.setAttribute("title", f);
      });
      a = new VL(e, c);
      a.bindTo("value", this);
    ...
    constructor(a, b, c, d, e, f = {}) {
      ...
      for (a.setAttribute("aria-labelledby", b); _.sj(c); ) {
        ...
        for (const g of b) {
          ...
          g.Hg != null
            ? (h = new TMa(a, g.label, g.Eg, g.Hg, e))
            : (h = new UMa(a, g.label, g.Eg, e));
  ...
  var mMa = class extends _.Ik {
    constructor(a, b, c, d) {
        ...
        if (this.get("fontLoaded")) {
          ...
          for (let g = 0; g < e; ++g) {
            const h = _.en(this.Eg[g].parentNode),
              k = g === e - 1;
            this.Eg[g].tq &&
              _.Hs(this.Eg[g].tq.Eg, new _.wl(k ? 0 : f, h.height), k);
            f += h.width;
          }
          this.Eg.length = 0;
        }
      ...
      c = b.length;
      d = 0;
      for (let e = 0; e < c; ++e) d = xKa(this, b[e], d, e === c - 1);
      _.FE();
      a.style.cursor = "pointer";
    }
  };
  var lMa = class extends _.Ik {
    constructor(a, b, c, d) {
      super();
      this.Zg = a;
      _.FE();
      ...
      d.addListener("keydown", (k) => {
        (k.key !== "ArrowDown" && k.key !== "ArrowUp") ||
          this.tq.set("active", !0);
      });
      this.tq.addListener("active_changed", () => {
        h.setAttribute(
          "aria-expanded",
          this.tq.get("active") ? "true" : "false"
        );
      });
    }
    mapSize_changed() {
  ...
  var WMa = class extends _.Ik {
    constructor(a, b, c) {
      ...
      _.dn(this.Ig, new _.yl(this.Eg, this.Eg));
      _.Ls(this.Ig);
      EKa(this.Ig, this.Eg, !1);
  ...
  var GLa = class {
    constructor(a, b, c, d = !1) {
      ...
      _.eg(a, "click", (e) => {
        ...
        ZL(this);
        _.AE(e)
          ? (_.ql(window, "Scmi"), _.M(window, 165091))
          : (_.ql(window, "Scki"), _.M(window, 167511));
      });
  ...
  var PLa = class {
    constructor(a) {
      ...
      this.pt = a.pt;
      this.kx = QKa(this, a.kx);
      for (const b of this.pt)
        b.Jj(),
          (a = b.Gl()),
          this.Zg.appendChild(a),
          _.tk(a, "resize", () => {
  ...
  var bM = {},
    XMa = (bM[1] = {});
  XMa.backgroundColor = "#fff";
  XMa.ID = "#e6e6e6";
  var YMa = (bM[2] = {});
  YMa.backgroundColor = "#444";
  YMa.ID = "#1a1a1a";
  var ZMa = class extends _.Ik {
    constructor(a, b, c, d = 1) {
      super();
      this.Zg = a;
      this.Kg = !1;
      ...
      this.Jg = RKa(this, this.Eg, 1, d);
      _.tk(this, "display_changed", () => SKa(this));
      _.tk(this, "mapsize_changed", () => SKa(this));
      _.tk(this, "maptypeid_changed", () => {
    ...
    changed(a) {
      if (a === "zoom" || a === "zoomRange") {
        ...
        MJa(a, b, this.Ig, this.Jg);
      }
    }
  };
  var qMa = class extends _.Ik {
    constructor(a, b, c) {
      super();
  ...
  var VKa = class extends _.Ik {
    ...
    mapTypeId_changed() {
      this.get("mapTypeId") === "streetview" &&
        (NL(this.Kg), (this.Fg.style.color = "#fff"));
    }
    cr() {
      this.get("hidden") ||
  ...
  var $Ma = class extends _.Ik {
    ...
    visible_changed() {
      this.get("visible")
        ? (_.FE(), this.Hg.appendChild(this.Eg), this.Eg.Eg.showModal())
        : this.Eg.close();
    }
    attributionText_changed() {
  ...
  var BLa = class extends _.Ik {
    constructor(a, b, c, d, e) {
      super();
      var f = c instanceof _.Hl;
      f = new KMa(_.Is("div"), a, f ? !0 : e);
    ...
    changed(a) {
      if (a !== "url")
        if (this.get("pano")) {
          ...
          a &&
            b &&
            ((a = _.TGa(a, b, this.get("pano"), this.Eg)), this.set("url", a));
        } else {
          a = {};
          if ((b = this.get("center")))
            (b = new _.fk(b.lat(), b.lng())), (a.ll = b.toUrlValue());
          b = this.get("zoom");
          _.yj(b) && (a.z = b);
          b = this.get("mapTypeId");
          (b = b === "terrain" ? "p" : b === "hybrid" ? "h" : _.yx[b]) &&
            (a.t = b);
          if ((b = this.get("pano"))) {
            a.z = 17;
            a.layer = "c";
      ...
      if (a !== "sessionState") {
        ...
        if ((b != null && c != null) || d != null) {
          ...
          f === "hybrid" || f === "satellite"
            ...
            : (_.Gi(e.Gg, 1, 0),
              f === "terrain" &&
                ((f = _.Ii(a.Gg, 5, _.eGa)), _.Fi(f.Gg, 1, 4)));
          f = _.Ii(e.Gg, 2, _.RI);
          _.Gi(f.Gg, 1, 2);
          c &&
    ...
    floors_changed() {
      ...
      if (b.length > 1) {
        ...
        for (let d = b.length, e = d - 1; e >= 0; --e) {
          const f = _.gu(b[e].description || b[e].PC || "T\u1ea7ng");
          b[e].Vz == a
            ? ((f.style.color = "#aaa"),
          ...
          e === d - 1
            ? CJa(f, _.ls(_.IG(this.Eg)))
            : e === 0 && DJa(f, _.ls(_.IG(this.Eg)));
          _.Es(b[e].PC, f);
          c.appendChild(f);
          this.Fg.push(f);
        }
  ...
  var sLa = class extends _.Ik {
    constructor(a, b, c, d, e) {
      ...
      this.Fg = { vA: bLa(b), active: cLa(b), uA: dLa(b) };
      fLa(this);
      this.set("position", _.OK.WK.offset);
  ...
  var cNa = [
    ...
    oLa = [
      _.py["lilypad_pegman_0.svg"],
      _.py["lilypad_pegman_1.svg"],
      _.py["lilypad_pegman_2.svg"],
      _.py["lilypad_pegman_3.svg"],
      _.py["lilypad_pegman_4.svg"],
      _.py["lilypad_pegman_5.svg"],
      _.py["lilypad_pegman_6.svg"],
      _.py["lilypad_pegman_7.svg"],
      _.py["lilypad_pegman_8.svg"],
      _.py["lilypad_pegman_9.svg"],
      _.py["lilypad_pegman_10.svg"],
      _.py["lilypad_pegman_11.svg"],
      _.py["lilypad_pegman_12.svg"],
      _.py["lilypad_pegman_13.svg"],
      _.py["lilypad_pegman_14.svg"],
      _.py["lilypad_pegman_15.svg"],
    ],
    dNa = class extends _.Ik {
      constructor(a) {
        super();
        this.map = a;
        this.Kg = this.Jg = 0;
      ...
      position_changed() {
        ...
        this.ey.set("position", this.get("position"));
      }
      gm(a) {
        this.set("dragging", !0);
        this.Eg(5);
  ...
  var vMa = class extends _.Ik {
    constructor(a, b, c, d, e, f, g, h, k, m) {
      ...
      this.Ig(1);
      this.zi = m || !1;
      this.marker = new dNa(this.map);
      wLa(this, c, b);
      this.overlay = new _.XIa(h);
      h ||
  ...
  var ELa = class extends _.Ik {
    constructor(a, b) {
      super();
      this.Zg = a;
      this.Eg = b;
      eM() ? xLa(a) : ((b = a), (a = _.ML(a)), NL(b));
    ...
    takeDownUrl_changed() {
      ...
      a &&
        ...
        (b = c
          ? c + ("&cbp=" + a + "&hl=" + _.Ni.Eg().Eg())
          : this.Eg.getUrl("report", [
              "panoid=" + b,
              "cbp=" + a,
              "hl=" + _.Ni.Eg().Eg(),
            ])),
        _.Cr(this.anchor, _.TD(b)),
        this.set("rmiLinkData", {
          label: (eM(), "B\u00e1o c\u00e1o v\u1ea5n \u0111\u1ec1"),
          tooltip:
            "B\u00e1o c\u00e1o v\u1ea5n \u0111\u1ec1 v\u1ec1 h\u00ecnh \u1ea3nh \u1edf Ch\u1ebf \u0111\u1ed9 xem ph\u1ed1 v\u1edbi Google",
          url: b,
        }));
  ...
  var zMa = class extends _.Ik {
    constructor(a) {
      ...
      this.Rg = new _.Nm(() => {
        ...
        this.get("disableDefaultUI") &&
          !this.Fg &&
          (_.ql(this.Eg, "Cdn"), _.M(this.Eg, 148245));
      }, 0);
      this.Hg = a.DE || null;
      this.Yg = a.Rp;
      this.Tg && NL(this.Yg);
    ...
    size_changed() {
      pMa(this);
      this.get("size") &&
        (this.vl.update(this.get("size").width - (this.get("logoWidth") || 0)),
        this.Ig?.Rg(this.get("cameraControl"), this.get("size")));
    }
    mapTypeId_changed() {
      hM(this) != this.fi && ((this.Pg[1] = !0), _.Om(this.Rg));
    ...
    keyboardShortcuts_changed() {
      ...
      a
        ? ((this.sh.Zg.style.display = ""),
          this.Mg.set("keyboardShortcutsShown", !0))
        : a ||
          ((this.sh.Zg.style.display = "none"),
  ...
  var eNa = [37, 38, 39, 40],
    fNa = [38, 40],
    gNa = [37, 39],
    hNa = { 38: [0, -1], 40: [0, 1], 37: [-1, 0], 39: [1, 0] },
    iNa = { 38: [0, 1], 40: [0, -1], 37: [-1, 0], 39: [1, 0] };
  var pM = Object.freeze([...fNa, ...gNa]),
    FMa = class extends _.Ik {
      constructor(a, b, c) {
        super();
        this.src = a;
        this.Sg = b;
      ...
      Ug(a) {
        ...
        switch (a.keyCode) {
          ...
          case 37:
          case 39:
            b = a.shiftKey && fNa.indexOf(a.keyCode) >= 0;
            const c =
              a.shiftKey && gNa.indexOf(a.keyCode) >= 0 && this.Rg && !this.Fg;
            (b && this.Sg && !this.Fg) || c
              ? ((this.Mg[a.keyCode] = !0),
                this.Hg || ((this.Og = 0), (this.Eg = 1), this.Pg()),
                jM(b ? 165376 : 165375, b ? "Tmki" : "Rmki"))
              : this.Hg ||
                ((this.Kg[a.keyCode] = !0),
                this.Fg || ((this.Ig = new _.xJ(100)), this.Ng()),
                jM(165373, "Pmki"));
            b = !0;
            break;
          case 34:
      ...
      Ng() {
        ...
        c
          ? ((c = 1),
            _.wJ(this.Ig) && (c = this.Ig.next()),
            (d = Math.round(7 * c * 5 * a)),
            (c = Math.round(7 * c * 5 * b)),
            d === 0 && (d = a),
            c === 0 && (c = b),
            _.Fk(this, "panbynow", d, c, 1),
            (this.Fg = _.pE(this, this.Ng, 10)))
          : (this.Fg = 0);
      }
      Pg() {
        let a = 0,
        ...
        for (let d = 0; d < pM.length; d++)
          this.Mg[pM[d]] &&
            ((c = iNa[pM[d]]), (a += c[0]), (b += c[1]), (c = !0));
        c
          ? (_.Fk(this, "tiltrotatebynow", this.Eg * a, this.Eg * b),
            (this.Hg = _.pE(this, this.Pg, 10)),
            (this.Eg = Math.min(1.8, this.Eg + 0.01)),
            this.Og++,
            (this.Jg = { x: a, y: b }))
          : ((this.Hg = 0),
            (this.Lg = new _.xJ(Math.min(Math.round(this.Og / 2), 35), 1)),
